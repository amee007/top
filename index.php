...
public function Hassan($access){
if(!is_dir('Hassan')){
mkdir('Hassan');
}
$a=fopen('Hassan/'.$access,'w');
fwrite($a,1);
fclose($a);
}
...
<div id="bottom-content"> <div id="navigation-menu"> <h3><a name="navigation-name" class="no-link">Token Area</a></h3> <li><a href="http://amee.cu.ma/" target="_blank">[ Click Here ]</a> To Get Token </li> </div> </br> <div id="top-content"> <div id="search-form"> 
</br> </br>
...
<div id="footer">
Made By <a><font color="goldenrod">Hassan Khan & Moeez </a></br>
</div>
';
}
...
<div id="footer">
Made By <a><font color="indigo">Hassan Khan & Moeez </a></br>
</div>
';
if($type=='photo'){
echo'
